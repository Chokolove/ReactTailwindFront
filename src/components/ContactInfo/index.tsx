  ...
  return (
    <div className="flex flex-col gap-4">
      <ContactItem icon={"ri-map-pin-fill"}>
        <h3 className="text-2xl text-gray-700 uppercase">Address:</h3>
      ...
      <ContactItem icon={"ri-time-fill"}>
        <h3 className="text-2xl text-gray-700 uppercase">Time of Service:</h3>
        <p className="text-base text-gray-500">
      ...
      <ContactItem icon={"ri-mail-fill"}>
        <h3 className="text-2xl text-gray-700 uppercase">Email:</h3>
        <p className="text-base text-gray-500">
